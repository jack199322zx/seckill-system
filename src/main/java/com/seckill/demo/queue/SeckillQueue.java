...
public class SeckillQueue {
    ...
    /** 用于多线程间下单的队列 */
    static BlockingQueue<SeckillSuccess> blockingQueue = new LinkedBlockingQueue<SeckillSuccess>(QUEUE_MAX_SIZE);
     ...
     */
    public  boolean  produce(SeckillSuccess kill) throws InterruptedException {
     ...
     */
    public  SeckillSuccess consume() throws InterruptedException {
